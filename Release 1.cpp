...
Clock::Clock() : hour(10), minute(00), second(00) {}
...
public:
	...
	void displayschedule()
	{
		...
		for (int i = 0; i < slotlist.size(); i++)
		{
			...
			{
				cout << "\t\t| Date: " << slotlist[i].mytime.date << " ";
	...
	void generate_ratecard() {
		...
		cout << "\t\t---------------------------------------------------------------------------------" << endl;
		cout << "\n\n\t\t\tYour Selected time slots with prices are as follows: " << endl << endl;
		for (int i = 0; i < number.size(); i++) {
		...
		cout << "\t\t---------------------------------------------------------------------------------" << endl;
		double tax;
		tax = total_price * (2.5 / 100);
		double price = total_price - tax;
		cout << "\t\tTax: 2.5%" << endl;
		cout << "\t\tPrice after tax: " << price << endl;
		cout << "\t\t---------------------------------------------------------------------------------" << endl;
	...
	void package_ratecard(double price) {
		system("cls");
		int i = 0;
		cout << endl << "\t\t\t\t\t\tInvoice Checkout" << endl;
		cout << "\t\t---------------------------------------------------------------------------------" << endl << endl;
		getclientinfo();
		//generate_ratecard();
		...
		double tax;
		tax = total_price * (2.5 / 100);
		double pricee = total_price - tax;
		cout << "\t\tTax: 2.5%" << endl;
		cout << "\t\tPrice after tax: " << pricee << endl;
		cout << "\t\t---------------------------------------------------------------------------------" << endl;
	}
	...
	void display_package() {
		...
		cout << "\t\t| Total price :" << (slotlist[0].price + slotlist[1].price + slotlist[2].price + slotlist[3].price) - 20;
		cout << endl << "\t\t---------------------------------------------------------------------------------" << endl;
		cout << endl << "\t\t\t\t\t\tSilver Package"  << endl;
		cout << "\t\t---------------------------------------------------------------------------------" << endl;
		for (int i = 3; i < 5; i++)
		{
			cout << "\t\t| Date: " << slotlist[i].mytime.date << " ";
		...
		cout << "\t\t| Total price :" << (slotlist[3].price + slotlist[4].price) - 15;
		cout << endl << "\t\t---------------------------------------------------------------------------------" << endl;
		cout << endl << "\t\t\t\t\t\tBronze Package" << endl;
		cout << "\t\t---------------------------------------------------------------------------------" << endl;
		for (int i = 8; i < 10; i++)
		...
		cout << endl << "\t\t| Total price :" << (slotlist[8].price + slotlist[9].price) - 10;
		cout << endl << "\t\t---------------------------------------------------------------------------------" << endl;
		cout << endl << "\t\t| Press 1 for Premium Package" << "\t2 for Silver Package" << "\t3 for Bronze Package |" << endl;
		cout << "\t\t---------------------------------------------------------------------------------" << endl;
		cout << endl << "\t\t\t\t| Press 4 to make your own Package \t|" << endl;
		cin >> select_package;
		if (select_package == 1) {
			premium_package();
		}
